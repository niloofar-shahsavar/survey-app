  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] transition-colors duration-200 flex items-center justify-center">
        <div className="text-gray-400 dark:text-gray-500">Loading statistics...</div>
      </div>
    );
  }
          ...
          <div className="space-y-6">
            {data?.questions.map((question, index) => (
              ...
              >
                ...
                {question.type === "multiple_choice" && question.option_counts && (
                  <div className="space-y-2">
                    {Object.entries(question.option_counts)
                      .sort(([, a], [, b]) => b - a)
                      .map(([option, count]) => {
                        const percentage = question.option_percentages[option] || 0;
                        const maxCount = Math.max(...Object.values(question.option_counts));
                        return (
