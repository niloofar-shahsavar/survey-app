...
const Footer = () => {
  return (
    <footer className="bg-gray-900/80 border-t border-gray-800/50">
      {/* Main Footer Content */}
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:hello@survii.com" className="text-gray-400 hover:text-white transition-colors text-sm">
                    hello@survii.com
                  </a>
                </li>
              </ul>
        ...
        <div className="px-6 md:px-12 py-6">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © 2026 Survii AB. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link to="/about" className="text-gray-500 hover:text-gray-300 transition-colors text-sm">
                Privacy Policy
              </Link>
              <Link to="/about" className="text-gray-500 hover:text-gray-300 transition-colors text-sm">
                Terms of Service
              </Link>
              <Link to="/contact" className="text-gray-500 hover:text-gray-300 transition-colors text-sm">
                Cookie Policy
              </Link>
            </div>
          </div>
